...
# Splits the list of names so that it can be easier to manipulate.

name_list = names.split(",")

roulette = random.randint(0, len(name_list) - 1)            # Randomly draws an integer that won't exceed the name_list index
