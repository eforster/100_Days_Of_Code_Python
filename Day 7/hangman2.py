...
Randomly chooses a word from a list and allocates a underscore per letter to be guessed, asks the user to guess a letter and make it lowercase, print if letter is in the word and replace the blanks.
